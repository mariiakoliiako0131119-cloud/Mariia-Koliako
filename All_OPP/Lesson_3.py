...
#         assert self.is_valid_radius(radius), ('радиус вне зоны доступа диапозона')
#         self.radius = radius
#
# c = Circle(10)
# print(c.area(c.radius))

# Расширь Circle, добавив обычный метод print_info, который выводит:
# Радиус: ...
...
#         if isinstance(login, str) and isinstance(password, str): # isinstance(login, str) → логин является строкой?
#             self.__login = login
#             self.__password = password
#         else:
#             raise ValueError("Логин и пароль должны быть строками")
#
#     def get_credentials(self):
#         return (self.__login, self.__password)
#
# user1 = User("Maria", 'Qweasdf123')
# user1.login = "Anna"
# user1.password = "hifjh422"
